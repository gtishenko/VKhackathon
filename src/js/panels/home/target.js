...
class HomePanelTarget extends React.Component {
            ...
            <Panel id={id}>
                ...
                <FormLayout>
                    ...
                    <FormLayoutGroup top="Цель">
                        ...
                        }} maxLength="25" placeholder="Например, лечение человека"/>
                    </FormLayoutGroup>
                    ...
                    <Button disabled={this.state.buttonDisabled} onClick={() => setPage('home','additionally')} size="xl">Далее</Button>
                </FormLayout>
            </Panel>
        );
    }
...
export default connect(null, mapDispatchToProps)(HomePanelTarget);
export var Img;
export var Name;
