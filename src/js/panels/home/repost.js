...
class HomePanelRepost extends React.Component {
    ...
    render() {
        ...
        return (
            <Panel id={id}>
                <PanelHeader right={<PanelHeaderButton><Icon24Send onClick={ () => setPage('home','feed') } /></PanelHeaderButton>} left={<PanelHeaderBack onClick={() => goBack()} />}>Матвей</PanelHeader>
...
export default connect(null, mapDispatchToProps)(HomePanelRepost);
export var Textt;
