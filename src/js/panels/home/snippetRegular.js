...
class HomePanelSnippetRegular extends React.Component {
    ...
    render() {
        ...
        return (
            <Panel centered id={id}>
                ...
                <CardGrid>
                    <Card onClick={() => setPage('home','longgridRegular')} style={{ backgroundColor: '#ffffff', border: '0.5px solid rgba(0, 0, 0, 0.08)', boxShadow: '0px 0px 6px rgba(0, 0, 0, 0.04), 0px 2px 4px rgba(0, 0, 0, 0.01)', width: 380 }} size="l">
                        <div style={{ height: 246 }}>
                            ...
                            <Div>
                                ...
                                <Subhead style={{ color: '#818C99' }} weight="regular">{firstName} {lastName} · Помощь нужна каждый месяц</Subhead>
                                <Separator style={{ marginTop: 8, marginBottom: 8 }} />
                                <div style={{display: 'flex'}}>
                                <InfoRow style={{ width: '70%', marginRight: 12 }} className="test" header={"Собрано в сентябре " + (Price/4).toFixed() + " ₽ из " + Price + " ₽"}>
                                    <Progress style={{ marginTop: 6 }} value={87} />
                                </InfoRow>
...
export default connect(null, mapDispatchToProps)(HomePanelSnippetRegular);
