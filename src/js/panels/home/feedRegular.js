...
import {Textt} from './repostRegular';
...
class HomePanelFeedRegural extends React.Component {
    ...
    render() {
        ...
        return (
            <Panel id={id}>
                ...
                <CardGrid>
                    <Card onClick={() => setPage('home','longgridRegular')} style={{ backgroundColor: '#ffffff', border: '0.5px solid rgba(0, 0, 0, 0.08)', boxShadow: '0px 0px 6px rgba(0, 0, 0, 0.04), 0px 2px 4px rgba(0, 0, 0, 0.01)' }} size="l">
...
export default connect(null, mapDispatchToProps)(HomePanelFeedRegural);
